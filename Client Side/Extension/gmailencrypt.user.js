...
function putButtons() {
	...
	var sendrow;
    sendrow = getElementsByAttribute(theframe,"div","role","navigation");
	//GM_log('SendRow ' + sendrow);
	//GM_log(sendrow.innerHTML);
	...
	//GM_log("Adding the buttons");
	var divTag = document.createElement("div");
	divTag.setAttribute('id', 'encryptdiv');
	divTag.setAttribute('style', '-moz-border-radius: 10px; background: white; margin: 10px 7px 0 0; padding: 3px;');
