...
public class Util {
	...
	public static float convertToFloat(String strToConvert, float defaultValue) {
		float floatValue = defaultValue;
		try {
			floatValue = Float.valueOf(strToConvert);
	...
	public static int convertToInteger(String strToConvert, int defaultValue) {
		int intValue = defaultValue;
		try {
			intValue = Integer.valueOf(strToConvert);
		} catch (NumberFormatException ex) {
	...
	public static long convertToLong(String strToConvert, long defaultValue) {
		long longValue = defaultValue;
		try {
			longValue = Long.valueOf(strToConvert);
		} catch (NumberFormatException ex) {
